  ...
  return (
    <div>
      ...
      <div className="meter-box">
        ...
        {average == 0 && showScore && <img src="/Peter2.svg" alt="Peter"></img>}
      ...
      {average == 1 && showScore && <div className="cooked-img"><img src="/Cooked1.svg" alt="Peter"/>1/5 This will be a well seasoned quarter!</div>}
